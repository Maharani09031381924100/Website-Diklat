...
@section('title', 'Mahasiswa Praktik Klinik')
...
@section('container')
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px; height: 100vh; position: fixed; align: left; background-color: #81C784;">
                ...
                <hr>
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li class="nav-item">
                        <a href="/mahasiswa" class="nav-link link active" aria-current="page" style="background-color:#C5E1A5;">
    ...
    <div class="container" style= "margin: 0 auto; text-align: center;">
      <h1>Isi Sementara Mahasiswa Praktik Klinik</h1>
    </div>
@endsection
